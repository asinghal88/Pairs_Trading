...
hedgeTrainingStartDate = as.Date("2014-12-31") #Start date for training the hedge ratio
hedgeTrainingEndDate = as.Date("2017-12-31") #End date for training the hedge ratio

symbolLst<-c("ADBE","CERN")
...
testForCointegration <- function(stockPairs){
  ...
  regression <- lm(dailyRet.a ~ dailyRet.b,data=stockPair)
